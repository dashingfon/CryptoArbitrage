...
class TestTransferAndRecieve():
    ...
    def test_transferTokenOwner(self, deployToken, Arb):
        amount = 1e10
        prevBal = deployToken.balanceOf(Arb)
        Arb.sendToken(deployToken, accounts[0], amount,
                      {'from': accounts[0]})
    ...
    def test_transferTokenNotOwner(self, deployToken, Arb):
        with brownie.reverts():
            amount = 1e10
            Arb.sendToken(deployToken.address, accounts[0].address,
...
def test_unpack(Arb):
    ...
    addresses = ['0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c',
                 '0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c']
    data = [b'0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c',
            b'0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c']
