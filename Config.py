...
DodoPools = {
    ...
    ('WNEAR', 'WETH') : '0xedE8950332E6B618C53E7506bca92012702CA697'
}

startTokens = ['USDT', 'USDC', 'WNEAR', 'WETH']
...
AuroraExchanges = {
    'trisolaris' : {
        ...
        frozenset(('WNEAR', 'WETH')) : '0x63da4DB6Ef4e7C62168aB03982399F9588fCd198',
        frozenset(('WNEAR', 'USDC')) : '0x20F8AeFB5697B77E0BB835A8518BE70775cdA1b0',
        frozenset(('WNEAR', 'USDT')) : '0x03B666f3488a7992b2385B12dF7f35156d7b29cD',
        frozenset(('USDC', 'USDT')) : '0x2fe064B6c7D274082aa5d2624709bC9AE7D16C77',
        frozenset(('WNEAR', 'WBTC')) : '0xbc8A244e8fb683ec1Fd6f88F3cc6E565082174Eb',
        frozenset(('AURORA', 'WNEAR')) : '0x1e0e812FBcd3EB75D8562AD6F310Ed94D258D008',
    },

    'auroraswap' : {
        frozenset(('USDT', 'USDC')) : '0xec538fafafcbb625c394c35b11252cef732368cd',
        frozenset(('USDC', 'WNEAR')) : '0x480a68ba97d70495e80e11e05d59f6c659749f27',
        frozenset(('USDT', 'WNEAR')) : '0xf3de9dc38f62608179c45fe8943a0ca34ba9cefc',
        frozenset(('WNEAR', 'WETH')) : '0xc57ecc341ae4df32442cf80f34f41dc1782fe067',
        frozenset(('WETH', 'WBTC')) : '0xcb8584360dc7a4eac4878b48fb857aa794e46fa8'
    },

    'wannaswap' : {
        frozenset(('AURORA', 'WNEAR')) : '0x7e9ea10e5984a09d19d05f31ca3cb65bb7df359d',
        frozenset(('WNEAR', 'WBTC')) : '0xbf58062d23f869a90c6eb04b9655f0dfca345947',
        frozenset(('WNEAR', 'WETH')) : '0x256d03607eee0156b8a2ab84da1d5b283219fe97',
        frozenset(('USDC', 'WNEAR')) : '0xbf560771b6002a58477efbcdd6774a5a1947587b',
        frozenset(('USDT', 'WNEAR') ): '0x2e02bea8e9118f7d2ccada1d402286cc6d54bd67',
